...
void dotProduct(seal::Ciphertext &first, seal::Ciphertext &second, seal::Ciphertext &dot, size_t slotCount, seal::Evaluator &evaluator, seal::RelinKeys &relinKeys, seal::GaloisKeys &galoisKeys);
void sumValues(seal::Ciphertext &vector, size_t slotCount, seal::Evaluator &evaluator, seal::GaloisKeys &galoisKeys);
void requestParamsFromServer();

/*
Helper functions to parse input from HTTP responses
*/
